...
user in an INI file next to LANMessengerPortable.exe called LANMessengerPortable.ini.
...
copy AppNamePortable.ini from this directory to LANMessengerPortable.ini next to
LANMessengerPortable.exe. The options in the INI file are as follows:
